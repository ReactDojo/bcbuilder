...
export const verticalMenuItems = [ 
    ...
    new Menu(2, 'Profile', null, null, 'person_add', null, true, 0), 
    new Menu(3, 'My Profile', '/dynamic-menu', null, 'keyboard', null, false, 2),     //users
    new Menu(4, 'Edit my Profile', '/dynamic-menu', null, 'keyboard', null, false, 2),     //users

    new Menu(5, 'My Account', '/register', null, 'library_books', null, false, 0),     //users
    new Menu(6, 'Change Log', '/schedule', null, 'event', null, false, 0),     //users
    new Menu(7, 'Projects', '/mailbox', null, 'format_list_bulleted', null, false, 0),              //mailbox
